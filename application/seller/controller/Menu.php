...
use app\seller\model\Menu as Menu_Model;
use app\common\controller\Sellerbase;
use think\Db;

class Menu extends Sellerbase
{
    ...
    public function index()
    {
        ...
        $tree->icon = array('&nbsp;&nbsp;&nbsp;│ ', '&nbsp;&nbsp;&nbsp;├─ ', '&nbsp;&nbsp;&nbsp;└─ ');
        $tree->nbsp = '&nbsp;&nbsp;&nbsp;';
        $result = Db::name('seller_menu')->order(array('listorder', 'id' => 'DESC'))->select();
        $array = array();
        foreach ($result as $r) {
    ...
    public function edit()
    {
        if ($this->request->isPost()) {
            ...
            $rs = Db::name('seller_menu')->where(["id" => $id])->find();
            $result = Db::name('seller_menu')->order(array('listorder', 'id' => 'DESC'))->select();
            $array = array();
            foreach ($result as $r) {
    ...
    public function delete()
    {
        ...
        $result = Db::name('seller_menu')->where(["parentid" => $id])->find();
        if ($result) {
